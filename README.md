...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/nameless-cake-da98)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/nameless-cake-da98
```

A live public deployment of this template is available at [https://nameless-cake-da98.templates.workers.dev](https://nameless-cake-da98.templates.workers.dev)
